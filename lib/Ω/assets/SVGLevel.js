            ...
            this.layers = toArray(xml.querySelectorAll(this.containerId + " > g")).map(function (layer) {
                ...
                var children = toArray(layer.childNodes).filter(function (c) {
                    ...
                    case "rect":
                        ...
                        o.rot = !transform ? 0 : transform.match(/\w+\([0-9\s-\.,]+\)/g).reduce(function (a, t) {
                            if (t.match(/rotate/g) ) {
                                return parseFloat(t.match(/[0-9\.]+/g)[0], 10);
                            }
                            return a;
                        }, 0);
                        break;
                    ...
                    case "polygon":
                        o.type = "polygon";
                        o.sides = Math.floor(c.getAttribute("points").split(" ").length / 2);
                        o.x = out.x;
                        o.y = out.y;
